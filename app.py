...
# convert categories like training
stroke_input = pd.get_dummies(stroke_input)

# force columns to match model training
model_columns = stroke_model.feature_names_in_
stroke_input = stroke_input.reindex(columns=model_columns, fill_value=0)
